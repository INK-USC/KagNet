...
class Config(object):
	...
	def restore_tensorflow(self):
		with self.graph.as_default():
			with self.sess.as_default():
				self.saver = tf.train.import_meta_graph(self.importName + ".meta")
				self.saver.restore(self.sess, self.importName)
				# self.saver = tf.train.import_meta_graph(".../openke_data/embs/glove_initialized/glove.transe.SGD.pt.meta")
				# self.saver.restore(self.sess, ".../openke_data/embs/glove_initialized/glove.transe.SGD.pt")
	...
	def predict_triple(self, h, t, r, thresh = None, returnValue=False):
